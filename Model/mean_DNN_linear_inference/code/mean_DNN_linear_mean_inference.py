...
# # open_path = r"D:\desktop\Scis_code\Deep Dive into ESM2\mean_DNN_linear_inference\data\in"
# # save_path = r"D:\desktop\Scis_code\Deep Dive into ESM2\mean_DNN_linear_inference\output"
# 
# open_path = './data/in'
# save_path = './output'
...
# # model = AutoModelForMaskedLM.from_pretrained(r"D:\desktop\big_model\esm2_t33_650M_UR50D", output_hidden_states=True)
# 
...
#                                                    compute_cls=False, compute_eos=False, compute_mean=True, compute_segments=False,
#                                                    #device_choose = 'auto'
#                                                    )
# 
...
# # cols = [col for col in human_df_represent.columns if re.match(r'ESM2_segment0_mean\d+', col)]
# # 
...
# 
# # X_inference_data= protein_sequence_df_represent.drop('label',axis=1)
# # y_inference_data= protein_sequence_df_represent.loc[:,'label'] #if using test data you need this step or not when in inference.
# 
...
# 
# # print(len(X_inference_data_probabilities))
# 
# 
